...
def uploadVideo():
    ...
    while True:
        ...
        if ret == True:
            ...
            msg = ""
            if avg >= 1000:
                msg = "Very high traffic green signal time : 60 secs"
            elif avg > 500 and avg < 1000:
                msg = "High traffic green signal time : 50 secs"
            elif avg > 100 and avg <= 500:
                msg = "Moderate traffic green signal time : 40 secs"
            elif avg > 50 and avg <= 100:
                msg = "Low traffic green signal time : 30 secs"
            else:
                msg = "Very low traffic green signal time : 20 secs"
            frame = cv2.resize(frame, (700, 500))    
            cv2.putText(frame, msg, (10, 25),  cv2.FONT_HERSHEY_SIMPLEX,0.9, (255, 0, 0), 2)    
...
exitButton = Button(main, text="Video Based Signal", command=uploadVideo)
